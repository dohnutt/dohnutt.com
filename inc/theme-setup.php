...
if ( ! function_exists('doh_theme_assets' ) ) {
  ...
  function doh_theme_assets() {
    ...
    wp_register_style( 'doh-style-light', get_doh_assets_dir_uri() . '/css/light.css', array('doh-style'), $ver, '(prefers-color-scheme: no-preference), (prefers-color-scheme: light)' );
