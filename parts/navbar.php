<header class="pg-header wrap">
	...
	<nav class="pg-navbar navbar navbar-expand-lg">
		...
		<button type="button" class="navbar-toggler collapsed ml-auto" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar" aria-label="<?php _e('Toggle navigation', 'doh-theme'); ?>">
